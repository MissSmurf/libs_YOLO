...
def draw_detections(image, boxes, scores, class_ids, mask_alpha, ids, mask_maps=None):
    ...
    for box, score, class_id, id in zip(boxes, scores, class_ids, ids):
        ...
        caption = f'{label} {int(score * 100)}% id: {int(id)}'
